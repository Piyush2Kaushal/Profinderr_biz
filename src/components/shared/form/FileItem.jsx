...
export function FileItem({ file, handleRemove, ...rest }) {
  ...
  return (
    <div
      className="dark:border-dark-450 flex w-full items-center justify-between rounded-lg border border-gray-200 p-3 md:p-4"
      {...rest}
    >
      <div className="mr-2 flex min-w-0 items-center space-x-2">
        <div className="dark:bg-dark-900 dark:text-dark-300 flex size-10 shrink-0 items-center justify-center rounded-lg bg-gray-100 text-gray-500">
          <Icon className="size-6" />
        </div>
        <div className="min-w-0">
          <p className="dark:text-dark-100 truncate text-gray-800">{name}</p>
