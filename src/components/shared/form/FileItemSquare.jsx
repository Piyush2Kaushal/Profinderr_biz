...
export function FileItemSquare({ file, handleRemove, ...rest }) {
  ...
  return (
    <div
      title={name}
      className="group ring-primary-600 dark:ring-primary-500 dark:ring-offset-dark-700 relative aspect-square size-20 rounded-lg ring-offset-4 ring-offset-white transition-all hover:ring-3"
      {...rest}
    >
      {isImage ? (
        <img
        ...
        <div className="bg-gray-150 dark:bg-dark-900 h-full w-full rounded-lg px-1 py-2 text-center select-none">
